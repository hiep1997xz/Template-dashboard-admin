...
export default function Card3d() {
  ...
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
      <a
        href="https://github.com/danielkatz51/React-3D-Cards-Animation?ref=reactjsexample.com"
        target="_blank"
        rel="noreferrer"
      ...
      <div className="container3d">
        <div
          ...
          <img
            ref={imgRef}
            src={require('../../assets/img-cart/Nike-Shoe.PNG')}
            alt="Nike-Shoe"
            className="sneaaker-img"
          />
          <h1 className="title3d" ref={titleRef}>
            Nike Dunk High
          </h1>
          <p ref={descRef}>
            Nike Dunk High is a high-top version of the classic Nike Dunk
            sneaker, featuring a padded collar for added support and comfort.
          </p>
