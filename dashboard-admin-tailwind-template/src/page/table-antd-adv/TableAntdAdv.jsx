...
import templateCrudTableAntdAdv from '../../assets/file-txt/templateCrudTableAntdAdv.txt'
...
const TableAntdAdv = () => {
  ...
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
      <div className="advTable_container">
